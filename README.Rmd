...
summarise both data set per village and the output is written in the `census.csv`
file of the `cleaned_data` folder of the DropBox Ecomore2 folder.
...
Generating the total number of people and the number of people per age
category:
